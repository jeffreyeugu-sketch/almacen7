          ...
          <table id="example" class="table table-striped table-bordered table-sm dt-responsive nowrap w-100">
            <thead>
              <tr class="column-filter dt-column-filter">
                ...
                <th><input type="text" class="form-control form-control-sm" placeholder="Marca"></th>
                <th><input type="text" class="form-control form-control-sm" placeholder="Presentacion"></th>
                <th><input type="text" class="form-control form-control-sm" placeholder="Equipo"></th>
            ...
            <tbody>
              <?php
                include ("../mysql.php");
                $sql = "";
                $sql = $sql . "select * from cat_dev_insumos";
                $rsp = odbc_exec($conn,$sql);
                {
                  while (odbc_fetch_row($rsp))
                  {
                    ...
                    <tr>
                      ...
                      <td><?php echo odbc_result($rsp,"IdFabricante_Nombre") ?></td>
