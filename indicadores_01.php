      <div class="row gutters-sm">
                  ...
                  <div class="row">
                    <div class="col-sm-6 col-lg-12 mb-3">
                      <div class="d-flex align-items-center justify-content-between mb-1">
                        <small class="text-secondary">Pacientes Promedio</small>
                    ...
                    <div class="col-sm-6 col-lg-12 mb-3">
                      <div class="d-flex align-items-center justify-content-between mb-1">
                        <small class="text-secondary">Pacientes priorotarios</small>
                        <small class="text-muted text-right"></small>
                      </div>
                      <div class="d-flex align-items-end justify-content-between">
                        <h5>85</h5>
                    ...
                    <div class="col-sm-6 col-lg-12 mb-3">
                      <div class="d-flex align-items-center justify-content-between mb-1">
                        <small class="text-secondary">Total de pacientes</small>
                        <small class="text-muted text-right"></small>
                      </div>
                      <div class="d-flex align-items-end justify-content-between">
                        <h5>512</h5>
        ...
        <div class="col-md-6 col-xl-4 mb-3">
          <div class="card h-100">
            <h6 class="card-header">Laboratorio de Rutina</h6>
            <div class="card-body">
              <div class="row gutters-sm">
              ...
              <div style="height: 170px">
                <canvas id="deviceSessions1"></canvas>
              </div>
            </div>
          </div>
        </div>
        <!-- /Device Sessions -->
                ...
                <div class="col-md-6 col-xl-4 mb-3">
          <div class="card h-100">
            <h6 class="card-header">Laboratorio de Urgencias</h6>
            <div class="card-body">
              <div class="row gutters-sm">
                <div class="col-4 col-lg">
                  <span class="text-primary">&#8857;</span>
              ...
              <div style="height: 170px">
                <canvas id="deviceSessions2"></canvas>
              </div>
            </div>
          </div>
        </div>
        <!-- /Device Sessions -->
                ...
                <div class="col-md-6 col-xl-4 mb-3">
          <div class="card h-100">
            <h6 class="card-header">Laboratorio de UCI</h6>
            <div class="card-body">
              <div class="row gutters-sm">
                <div class="col-4 col-lg">
                  <span class="text-primary">&#8857;</span>
              ...
              <div style="height: 170px">
                <canvas id="deviceSessions3"></canvas>
              </div>
            </div>
          </div>
        </div>
