          ...
          <table id="example" class="table table-striped table-bordered table-sm dt-responsive nowrap w-100">
            ...
            <tbody>
              <?php
                include ("../mysql.php");
                $sql = "";
                $sql = $sql . "select r.Remision, a.*, i.*, rd.Lote, rd.Caducidad ";
                $sql = $sql . "from _almacen a ";
                $sql = $sql . "left join _remisiones_detalle rd ON a.NoRegIns = rd.RegIns ";
                $sql = $sql . "left join _remisiones r ON rd.RegRem=r.NoReg  ";
                $sql = $sql . "left join cat_dev_insumos i ON a.NoRegIns = i.NoReg ";
                $sql = $sql . "where a.TipoMov='E'";
                //echo $sql;
