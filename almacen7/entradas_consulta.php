  <?php
    ...
    {      
      ...
      $sql = $sql . "where a.TipoMov='E'and a.NoMov = " . $_POST['NoReg'];
      //echo $sql;
      $rp = $dbh->prepare($sql);
      $rp->execute();
      $num_row=$rp->rowCount();
    ...
    ?>
      <div class="row">
        <div class="col">
            <div class="card">
              <div class="card-body"><b>Consulta de Entradas</b>
                <form>
                  <table class="table table-bordered table-form">
                    <tbody>
                      ...
                      <tr>
                        <td><label for="languageTableForm">Denominación</label></td>
                        <td>
        ...
        <div class="col">
            <div class="card">
              <div class="card-body">Detalle de movimientos
                ...
                <tbody>
                <tr>
                    <td><label for="firstNameTableForm">Tipo de Mov.</label></td>
                    <td><input type="text" class="form-control" id="Clave" placeholder=""
                      value="Entrada"
                      disabled
                      onFocus="JavaScript:FocoToma(this)" 
                      onBlur="JavaScript:FocoPierde(this)"
                  ...
                  <tr>
                    <td><label for="firstNameTableForm">Cantidad</label></td>
                    <td><input type="text" class="form-control" id="Clave" placeholder="Escriba la Clave del Registro"
                      value="<?php echo $rs['Cantidad'] ?>"
                      disabled
                      onFocus="JavaScript:FocoToma(this)" 
                      onBlur="JavaScript:FocoPierde(this)"
                    ></td>
                  ...
                  <tr>
                    <td><label for="firstNameTableForm">Denominación
                    </label></td>
                    <td><input type="text" class="form-control" id="Clave" placeholder="Escriba la Clave del Registro"
                      value="<?php echo $rs['IdPresentacion_Nombre'] ?>"
                      disabled
                      onFocus="JavaScript:FocoToma(this)" 
                      onBlur="JavaScript:FocoPierde(this)"
                    ></td>
                  ...
                  <tr>
                    <td><label for="firstNameTableForm">Destino</label></td>
                    <td><input type="text" class="form-control" id="Clave" placeholder="Escriba la Clave del Registro"
                  ...
                  <tr>
                    <td><label for="firstNameTableForm">Fecha de Mov.</label></td>
                    <td><input type="text" class="form-control" id="Clave" placeholder="Escriba la Clave del Registro"
                      value="<?php echo $rs['Fecha'] ?>"
                      disabled
                      onFocus="JavaScript:FocoToma(this)" 
                      onBlur="JavaScript:FocoPierde(this)"
                    ></td>
                  ...
                  <tr>
                    <td><label for="firstNameTableForm">Hora de Mov.</label></td>
                    <td><input type="text" class="form-control" id="Clave" placeholder="Escriba la Clave del Registro"
                      value="<?php echo $rs['Hora'] ?>"
                      disabled
                      onFocus="JavaScript:FocoToma(this)" 
                      onBlur="JavaScript:FocoPierde(this)"
                    ></td>
                  ...
                  <tr>
                    <td><label for="firstNameTableForm">Usuario</label></td>
                    <td><input type="text" class="form-control" id="Clave" placeholder="Escriba la Clave del Registro"
