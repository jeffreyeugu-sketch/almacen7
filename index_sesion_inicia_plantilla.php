<?php
  ...
  if (isset($_POST['Username']))
  {
    ...
    if (odbc_num_rows($rs)>=1)
    {
      ...
      $plantilla_params = "PANDA";
      $vars = 'plantillaID=notificacion_demo_01&whatsapp_phone=5215542027344&vars='.$plantilla_params;
      $headers = array(
      ...
      $ch = curl_init();
      curl_setopt($ch, CURLOPT_URL,$urlAPI."/envia/whatsapp/plantilla");
      ...
      if ($respuesta=="")
      {
        echo "Error|No se puede enviar el mensaje al Número de cell";      
      }
      else
      {
        echo "OK|" . odbc_result($rs,"clave") . "|" . session_id() . "|" . $_SESSION['CodigoW'] . "|";
      }
    }
    else
    {
